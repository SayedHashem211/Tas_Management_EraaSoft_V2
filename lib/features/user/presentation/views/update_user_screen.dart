                ...
                child: Form(
                  ...
                  child: Column(
                      children: [
                        ...
                        Text(
                          ''' Update user details and give them a
               new identity.
                         ''',
                          style: GoogleFonts.roboto(
                        ...
                        DropdownButton(
                          ...
                          onChanged: (String? newValue) {
                            UserCubit.get(context).changeUserValue(newValue);
                          },
                        ),
                        SizedBox(height: 5.h,),
                        SizedBox(
                                ...
                                onTap: () {
                                  if (formUserKey.currentState!.validate()) {
                                    ...
                                    UserCubit.get(context).updateUser(
                                        nameController.text, emailController.text, passwordController.text,  phoneController.text, userStatusController.text ,departmentIdController.text,);
                                  } else {
                                    FocusScope.of(context).unfocus();
                                  }
                                },
