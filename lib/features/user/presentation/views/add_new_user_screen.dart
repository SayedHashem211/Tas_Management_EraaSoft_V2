...
class _AddNewUserScreenState extends State<AddNewUserScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    MotionToast.success(
    description: Text(
      'user Created with id ${UserCubit.get(context).userModel?.data?.id}',
    maxLines: 3,
                              ...
                              builder: (context) => CustomButton(
                                ...
                                onTap: () {
                                  if (formUserKey.currentState!.validate()) {
                                    ...
                                    UserCubit.get(context).addUser(nameController.text, emailController.text, phoneController.text, passwordController.text);
                                  } else {
                                    FocusScope.of(context).unfocus();
                                  }
                                },
